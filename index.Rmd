...
This document is an online appendix to the paper *"Statistical Models for Benchmark Comparison"* by David Issa Mattos, Jan Bosch and Helena Holmström Olsson. It shows the process to analyze the data, including data preparation, modeling and plotting for all the models described on the paper. 
